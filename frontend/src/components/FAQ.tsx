 ...
 *
 * This component renders a list of questions and answers for the ImmersivΞ application,
 * styled to match the techy aesthetic with a simple toggle mechanism for showing/hiding answers.
 */
function FAQ() {
    return (
        <section className="py-16 mx-auto px-4">
            ...
            <div className="max-w-lg mx-auto space-y-4">
                <details className="bg-[var(--bg-color)] border border-[var(--text-color)] rounded-lg">
                    <summary className="p-4 text-[var(--text-color)] font-semibold cursor-pointer flex justify-between items-center">
                        <span>Do I need to download an app to view AR/VR content?</span>
                        <HiChevronDown className="ml-2 text-[var(--text-color)] text-sm" />
                    </summary>
                    <p className="p-4 text-sm text-[var(--text-color)] opacity-80">
                ...
                <details className="bg-[var(--bg-color)] border border-[var(--text-color)] rounded-lg">
                    ...
                    <p className="p-4 text-sm text-[var(--text-color)] opacity-80">
                        Sui is a new, high-performance blockchain known for its speed, low transaction fees, and suitability for interactive applications like 3D NFTs or AR/VR content.
                    </p>
                </details>
            </div>
        </section>
