        ...
        <section className="pt-24 pb-16 mx-auto px-4">
            ...
            <div className="max-w-lg mx-auto space-y-4">
                ...
                <details className="bg-[var(--bg-color)] border border-white/30 rounded-lg shadow-lg">
                    ...
                    <p className="p-4 text-sm text-[var(--text-color)] opacity-80">
                        Sui is a new, high-performance blockchain known for its secure, fast transactions, low fees, and suitability for interactive applications like 3D NFTs or AR/VR content.
                    </p>
                </details>
            </div>
        </section>
